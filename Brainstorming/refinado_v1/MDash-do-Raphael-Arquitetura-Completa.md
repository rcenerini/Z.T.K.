...
O escopo do MDash do Raphael vai além de validar achados do SAST: inclui **descoberta** de vulnerabilidades novas via fuzzing, no padrão do MDASH real — mas com acionamento restrito a solicitação humana explícita, nunca automático, dado o custo e tempo de execução.
